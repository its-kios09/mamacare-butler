...
class _V1AuthEndpoint {
  ...
  _i3.Future<_i5.AuthResponse> registerUser(
    _i1.TestSessionBuilder sessionBuilder,
    String phoneNumber,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<_i6.User?> getUserByPhone(
    _i1.TestSessionBuilder sessionBuilder,
    String phoneNumber,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            ...
            method: 'saveKickSession',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'v1KickCounter',
          methodName: 'saveKickSession',
          parameters: _i1.testObjectToJson({
            'userId': userId,
            'kickCount': kickCount,
  ...
  _i3.Future<List<_i7.KickSession>> getRecentKicks(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'v1KickCounter',
            method: 'getRecentKicks',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'v1KickCounter',
          methodName: 'getRecentKicks',
          parameters: _i1.testObjectToJson({
            'userId': userId,
            'days': days,
          }),
